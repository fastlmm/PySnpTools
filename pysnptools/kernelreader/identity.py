    ...
    **Constructor:**
    ...
    def __repr__(self):
        return "{0}({1}x{2})".format(
            self.__class__.__name__, self.row_count, self.col_count
        )
    ...
    def _read(
        ...
        if (
            row_index_or_none is None
            and col_index_or_none is None
            and self._row0 is self._row1
        ):  # read all of a square ID
