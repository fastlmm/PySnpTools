...
print(snpreaderD, snpreaderD.iid_count, snpreaderD.iid, snpreaderD.sid_coun)
...
print(henoreader, phenoreader.iid_count, phenoreader.sid_count, phenoreader.sid, phenoreader.pos)
